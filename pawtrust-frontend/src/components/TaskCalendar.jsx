...
//         height="auto"
//         selectable      // 允许点选空白区域
//         dayMaxEventRows // 月视图多事件折叠
//         events={events}
//         dateClick={(arg) => {
//           // arg.dateStr 是 YYYY-MM-DD 或 YYYY-MM-DDTHH:mm:ssZ
//           // 我们统一成 ISO 字符串（开始时间 09:00），你也可以自定义
//           const iso = new Date(arg.date).toISOString();
//           onCreate?.(iso);
//         }}
//         eventClick={(info) => {
